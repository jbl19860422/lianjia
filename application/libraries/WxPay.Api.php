...
class WxPayApi
{
	...
	public static function sendRedpacket($inputObj, $timeOut = 6) {
		...
		}else if(!$inputObj->IsWxappidSet()) {
			throw new WxPayException("缺少wxappid！");
		}else if(!$inputObj->IsSend_nameSet()) {
			throw new WxPayException("缺少商户名称！");
		}else if(!$inputObj->IsRe_openidSet()) {
			throw new WxPayException("缺少re_openid！");
		}else if(!$inputObj->IsTotal_amountSet()) {
			throw new WxPayException("缺少付款金额！");
		}else if(!$inputObj->IsTotal_numSet()) {
			throw new WxPayException("缺少total_num！");
		}else if(!$inputObj->IsWishingSet()) {
			throw new WxPayException("缺少wishing！");
		}else if(!$inputObj->IsAct_nameSet()) {
			throw new WxPayException("缺少act_name！");
		}else if(!$inputObj->IsRemarkSet()) {
			throw new WxPayException("缺少remark！");
		}
	...
	* @param 
	**/
	public static function  getRedpacketResult($inputObj, $timeOut = 6) {
