				...
				<form class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select v-model="community_edit.area_id" class="form-control" style="width:auto;display:inline;min-width:200px;">
									<option v-for="area in areas" v-html="area.name" :value="area.area_id"></option>
								</select>
							</div>
							<label class="col-sm-2 text-right">商圈选择：</label>
							<div class="col-sm-2">
								<select v-model="community_edit.ta_id" class="form-control" style="width:auto;display:inline;min-width:200px;">
									<option v-for="trade_area in trade_areas" v-html="trade_area.name" :value="trade_area.ta_id" v-if="trade_area.area_id==community_edit.area_id"></option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.name"></input>
							</div>
							<div class="col-sm-2">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.lat">
							</div>
							<label class="col-sm-2 text-right">纬度：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.lng">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 text-right">检索信息：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control"  v-model="community_edit.retriving_info">
							</div>
						</div>
					</fieldset>
								...
								<div class="form-group">
									...
									<ul class="subway-station-list area-list">
										<li :class="{btn:true, 'btn-warning':true, 'fl-l':true}" v-for="(subway_station,index) in stations" style="margin-right:20px;margin-left:0px">
											{{subway_station.station_name+'('+subway_station.distance+'米)'}}
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<ul class="school-list col-sm-10">
								<school-item v-for="school in community_edit.school_adds" :school="school" @del_school="delSchool"></school-item>
							</ul>
						</div>
					</fieldset>
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control cityinfo-input" v-model="community_edit.pm_fee"><div class="cityinfo-div-j">元/㎡</div></input>
							</div>
							<label class="col-sm-2 text-right">交易权属：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.transaction_ownership"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.property_year"></input>
							</div>
							<label class="col-sm-2 text-right">房屋用途：</label>
							<div class="col-sm-3">
								<select class="form-control" v-model="community_edit.usage">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<!--<input type="text" class="form-control" v-model="community_edit.building_type"></input>-->
								<select class="form-control" v-model="community_edit.building_type">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.bad_thing"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.lift_user_rate"></input>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.developer"></input>
							</div>
							
							<label class="col-sm-2 text-right">物业公司：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.prop_company"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.plot_ratio"></input>
							</div>
							
							<label class="col-sm-2 text-right">绿化率：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.green_rate"></input>
							</div>
						</div>
					</fieldset>
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.heat_type"></input>
							</div>
							<label class="col-sm-2 text-right">用电类型：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.electro_type"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.car_rate"></input>
							</div>
							<label class="col-sm-2 text-right">停车服务费：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.car_manager_fee"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.heat_fee"></input>
							</div>
							<label class="col-sm-2 text-right">用水类型：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.water_use_type"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.ground_car_park_count"></input>
							</div>
							<label class="col-sm-2 text-right">燃气费：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.gas_fee"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select v-model="community_edit.has_lift" class="form-control" style="display:inline;width:auto;min-width:200px">
							...
							<div class="col-sm-3">
								<select v-model="community_edit.has_gas" class="form-control" style="display:inline;width:auto;min-width:200px">
									<option value="0">无</option>
									<option value="1">有</option>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.underground_car_park_count"></input>
							</div>
							<label class="col-sm-2 text-right">是否有热水：</label>
							<div class="col-sm-3">
								<select v-model="community_edit.has_hot_water" class="form-control" style="display:inline;width:auto;min-width:200px">
									<option value="0">无</option>
									<option value="1">有</option>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.hot_water_fee"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select v-model="community_edit.has_warm_water" class="form-control" style="display:inline;width:auto;min-width:200px">
									<option value="0">无</option>
									<option value="1">有</option>
								</select>
							</div>
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.warm_water_fee"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" v-model="community_edit.child_school_info"></input>
							</div>
						</div>
					</fieldset>
				</form>
				<div class="col-sm-6 col-md-offset-3">
					<span class="btn btn-success btn-rounded btn-big cityinfo-btn-t" @click="editCommunity()">修改</span>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function formatDate(value) {   //鍏ㄥ眬鏂规硶 Vue.filter() 娉ㄥ唽涓€涓嚜瀹氫箟杩囨护鍣蹇呴』鏀惧湪Vue瀹炰緥鍖栧墠闈[0m
	   function add0(m) {
			return m<10?'0'+m:m;
	   }
	...
	$(function() {
		...
		g_page = new Vue({
			...
			data:{
				...
				community_edit:<?=json_encode($community)?>,
				school_add:{},
			...
			created:function() {
				...
				/*
				if(this.community_edit.school_adds) {
					this.community_edit.school_adds = JSON.parse(this.community_edit.school_adds);
				} else {
					this.community_edit.school_adds = [];
				}
				*/
			},
			mounted:function() {
				...
				this.myGeo.getPoint(this.community_edit.name, function(point){
					if (point) {
						console.log(point);
				...
				$(this.$el).find(".build-time").val(formatDate(this.community_edit.build_time));
				var d = $(this.$el).find(".build-time").datetimepicker(
				{
					language:  "zh-CN",
					weekStart: 1,
					todayBtn:  1,
			...
			watch:{
				"community_edit.name":function(val) {
					this.community_edit.retriving_info = makePy(val);
				},
			...
			methods:{
				addSchool:function() {
					...
					if(this.community_edit.school_adds.length >= 3) {
						showMsg("最多3个学校");
						return;
					}
					this.community_edit.school_adds.push(this.school_add);
				...
				delSchool:function(school) {
					var that = this;
					for(var i = 0; i < this.community_edit.school_adds.length; i++) {
						if(this.community_edit.school_adds[i].sc_id == school.sc_id) {
							this.community_edit.school_adds.splice(i,1);
							break;
						}
					}
					this.$forceUpdate();
				...
				selStation:function(station) {
					...
					this.curr_station.station_name = station.name;
				},
				...
				resolvePos:function() {
					...
					this.myGeo.getPoint(this.community_edit.name, function(point){
						console.log(point);
						if (point) {
							that.community_edit.lng = point.lng;
							that.community_edit.lat = point.lat;
							that.map.centerAndZoom(point, 18);
							that.map.addOverlay(new BMap.Marker(point));
						}else{
				...
				editCommunity:function() {
					var that = this;
					if(this.community_edit.ta_id == 0) {
						showMsg('请选择商圈');
						return;
					}
					...
					this.community_edit.build_time = timestamp2 / 1000;
					
					if(this.community_edit.name == '') {
						showMsg('小区名称为空');
						return;
					}
					
					API.invokeModuleCall(g_host_url,'cityinfo','editCommunity', {community:this.community_edit,stations:this.stations}, function(json) {
						if(json.code == 0) {
							showMsg('添加成功！');
							history.back(-1);
						}
