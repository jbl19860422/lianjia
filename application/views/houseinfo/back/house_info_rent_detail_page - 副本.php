...
<head>
	...
	<link href="../../../static/css/availability.css?v=2" rel="stylesheet">
...
<div id="content_warp">
	...
	<div class="mg-c">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="col-sm-4 availability-img">
					<img :src="house_info.house_img" style="cursor:pointer" id="ID_houseImg"></img>
				</div>
				<div class="col-sm-7">
					<div class="form-group"style="accelerator:60px;">
						<div class="col-sm-5">
							<div class="price"><P style="width:180px">{{house_info.price}}</p><div><i class="fa fa-arrow-circle-down"></i><p>元/月</p></div></div>
						</div>
						<div class="col-sm-6 price-d">
							<div style="cursor:pointer" @click="show_dlg_edit_price=true">调整房源租价</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-10 availability-f">
							...
							<div class="fl-l area">
								<div>
									<b>{{house_info.area}}(套内84.32)m2</b>
									<p>面积</p>
								</div>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7 availability-c">
							<div class="fl-l availability-c-div" style="position:relative">
								<span><a style="color:inherit" :href="'houseinfo/house_followup_edit_page?house_info_id='+house_info.house_info_id">录入跟进</a></span>
								<span>|</span>
								<a @click="jumpMaintain()">维护信息</a>
								<span>|</span>
								<a @click="jumpComment()">房源点评</a>
								<span>|</span>
		...
		<ul class="nav nav-pills nav-justified availability-ul" role="tablist">
	        <li role="presentation" class="active"><a href="#description" role="tab" data-toggle="tab" aria-expanded="true">房源描述</a></li>
	        <li role="presentation" class=""><a href="#information" role="tab" data-toggle="tab" aria-expanded="false">实勘信息</a></li>
	        <li role="presentation" class=""><a href="#follow-up" role="tab" data-toggle="tab" aria-expanded="false">跟进</a></li>
	        <li role="presentation" class=""><a href="#look-with" role="tab" data-toggle="tab" aria-expanded="false">带看</a></li>
	        <li role="presentation" class=""><a href="#similar" role="tab" data-toggle="tab" aria-expanded="false">相似房源</a></li>
	    </ul>
		<div class="tab-content" id="tab_content_b">
			...
			<div role="tabpanel" class="tab-pane active" id="description">
				...
				<div class="panel panel-default" id="ID_maintain_info">
					<div class="panel-heading panel-title">
						...
						<div class="panel-r" @click="edit_t()" v-show = "!edit_maintaininfo">
					...
					<div class="panel-body" v-show = "!edit_maintaininfo">
						<div class="form-group">
							...
							<ul class="col-sm-12">
								<li class="col-sm-6">出租原因：<span class="information-s" v-html="house_info.rent_reason"></span></li>
								<li class="col-sm-6"></li>
								<li class="col-sm-6">房屋现状：<span class="information-s" v-html="rent_house_state"></span></li>
								<li class="col-sm-6">可入住时间：<span class="information-s" v-html="house_info.launch_time"></span></li>
								<li class="col-sm-6">租赁方式：<span class="information-s" v-html="house_info.rent_method"></span></li>
								<li class="col-sm-6">自带车位：<span class="information-s" v-html="house_info.has_car_pos?'是':'否'">是</span></li>
								<li class="col-sm-6">租客要求：<span class="information-s" v-html="house_info.renter_require"></span></li>
							</ul>
						</div>
						
						<div class="form-group">
							<label class="col-sm-12">付款付佣</label>
							<ul class="col-sm-12">
								<li class="col-sm-6">付款方式：<span class="information-s" v-html="rent_pay_method"></span></li>
								<li class="col-sm-6">业主承担佣金：<span class="information-s" v-html="house_info.commission"></span>元</li>
								<li class="col-sm-6">承担比例：<span class="information-s" v-html="house_info.commission_rate"></span>%</li>
							</ul>
						</div>
						
						<div class="form-group">
							<label class="col-sm-12">装修配套</label>
							<ul class="col-sm-12">
								<li class="col-sm-6">装修状况：<span class="information-s" v-html="decoration_state"></span></li>
								<li class="col-sm-6">房屋格局是否有变动：<span class="information-s" v-html="house_info.house_pattern_changed?'是':'否'"></span></li>
								<li class="col-sm-6">已有配套：<span class="information-s" v-html="house_info.matching"></span></li>
								<li class="col-sm-6">业主可配：<span class="information-s" v-html="house_info.can_match"></span></li>
								<li class="col-sm-6">可清空家具：<span class="information-s" v-html="house_info.clear_furniture"></span></li>
							</ul>
						</div>
						
						<div class="form-group">
							<label class="col-sm-12">看房时间</label>
							<div class="col-sm-2">
								<label for="name">看房时间：<span class="information-s" v-html="openhome_time"></span></label>
							</div>
					...
					<div class="panel-body" v-show = "edit_maintaininfo">
						<form class="form-horizontal">
							<fieldset>
								<legend>业主相关</legend>
								<div class="form-group">
									<label class="col-sm-2 edit_label text-right">出租原因</label>
								    <div class="col-sm-4">
								    	<input type="text" class="form-control" v-model="house_info_edit.rent_reason" style="display:inline;width:auto"></input>
								    </div>
									
									<label class="col-sm-2 edit_label text-right">房屋现状</label>
								    <div class="col-sm-4">
								    	<select class="form-control" v-model="house_info_edit.rent_house_state" style="display:inline;width:auto">
								...
								<div class="form-group">
									<label class="col-sm-2 edit_label text-right">可入住时间</label>
								    <div class="col-sm-4">
								    	<input class="form-control" style="display:inline;width:auto" placeholder="选择或者输入一个日期：yyyy-MM-dd" id="ID_launchTime"></input>
								    </div>
									
									<label class="col-sm-2 edit_label text-right">租赁方式</label>
								    <div class="col-sm-4">
								    	<input type="text" class="form-control" v-model="house_info_edit.rent_method" style="display:inline;width:auto"></input>
								    </div>
								</div>
								<div class="form-group">
								    <label class="col-sm-2 edit_label text-right">自带车位</label>
								    <div class="col-sm-4">
								...
								<div class="form-group">
									<label class="col-sm-2 edit_label text-right">租客要求</label>
								    <div class="col-sm-4">
								    	<input type="text" class="form-control" v-model="house_info_edit.renter_require" style="display:inline;width:auto"></input>
								    </div>
								</div>
								<legend>付款付佣</legend>
								<div class="form-group">
									<label class="col-sm-2 edit_label text-right">付款方式</label>
								    <div class="col-sm-4">
								    	<select class="form-control" v-model="house_info_edit.rent_pay_method">
								...
								<div class="form-group">
									<label class="col-sm-2 edit_label text-right">业主承担佣金</label>
								    <div class="col-sm-4">
								    	<input type="text" class="form-control" v-model="house_info_edit.commission" style="display:inline;width:auto"></input>
								    </div>
								    <label class="col-sm-2 edit_label text-right">承担比例</label>
								    <div class="col-sm-4">
								    	<input type="tel" class="form-control" v-model="house_info_edit.commission_rate" style="display:inline;width:auto"></input>
								    </div>
								</div>
								<legend>装修配套</legend>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="col-sm-2 edit_label text-right">已有配套</label>
								    <div class="col-sm-4">
								    	<input type="text" class="form-control" v-model="house_info_edit.matching" style="display:inline;width:auto"></input>
								    </div>
								    <label class="col-sm-2 edit_label text-right">业主可配</label>
								    <div class="col-sm-4">
								    	<input type="tel" class="form-control" v-model="house_info_edit.can_match" style="display:inline;width:auto"></input>
								    </div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 edit_label text-right">可清空家具</label>
								    <div class="col-sm-4">
								    	<input type="text" class="form-control" v-model="house_info_edit.clear_furniture" style="display:inline;width:auto"></input>
								    </div>
								</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading panel-title">证件信息</div>
					<div class="panel-body">
						<div class="form-group">
				...
				<div class="panel panel-default" id="ID_house_comment">
					<div class="panel-heading panel-title">
						<p class="panel-p">房评</p>
						<div class="panel-r" @click="edit_f()" v-show="!edit_comment">
							<i class="fa fa-pencil-square-o"></i>编辑
						</div>
			...
			<div role="tabpanel" class="tab-pane" id="information">
				<div class="panel panel-default">
					<div class="panel-heading panel-title">实勘信息</div>
					<div class="panel-body">
						<div class="form-group">
						...
						<div class="form-group">
							...
							<ul class="col-sm-12">
								<li class="col-sm-4">
									<img src="../../../static/img/fang1.png" class="survey"/>
									<p class="survey-p">卧室A</p>
								</li>
								<li class="col-sm-4">
									<img src="../../../static/img/fang1.png" class="survey"/>
									<p class="survey-p">卧室B</p>
								</li>
								<li class="col-sm-4">
									<img src="../../../static/img/fang1.png" class="survey"/>
									<p class="survey-p">卧室C</p>
								</li>
								<li class="col-sm-4">
									<img src="../../../static/img/fang1.png" class="survey"/>
									<p class="survey-p">卫生间A</p>
								</li>
								<li class="col-sm-4">
									<img src="../../../static/img/fang1.png" class="survey"/>
									<p class="survey-p">卫生间B</p>
								</li>
								<li class="col-sm-4">
									<img src="../../../static/img/fang1.png" class="survey"/>
									<p class="survey-p">客厅</p>
								</li>
							</ul>
						</div>
					</div>
			...
			<div role="tabpanel" class="tab-pane" id="follow-up">
				<div class="panel panel-default">
					<div class="panel-heading panel-title">房屋照片信息</div>
					<div class="panel-body">
						<ul class="col-sm-12">
							<li class="col-sm-4" v-for="(room,index) in house_info.room_count">
								<img :src="house_info.follow_imgs.rooms&&house_info.follow_imgs.rooms[index]?house_info.follow_imgs.rooms[index]:'../../../static/img/upload_img.png'" class="follow-up-img" @click="uploadHouseImg('rooms',index)"/>
								<p class="follow-up-p">室{{index+1}}</p>
							</li>
							<li class="col-sm-4" v-for="(hall,index) in house_info.hall_count">
								<img :src="house_info.follow_imgs.halls&&house_info.follow_imgs.halls[index]?house_info.follow_imgs.halls[index]:'../../../static/img/upload_img.png'" class="follow-up-img" @click="uploadHouseImg('halls',index)"/>
								<p class="follow-up-p">厅{{index+1}}</p>
							</li>
							<li class="col-sm-4" v-for="(toilet,index) in house_info.toilet_count">
								<img :src="house_info.follow_imgs.toilets&&house_info.follow_imgs.toilets[index]?house_info.follow_imgs.toilets[index]:'../../../static/img/upload_img.png'" class="follow-up-img" @click="uploadHouseImg('toilets',index)"/>
								<p class="follow-up-p">卫生间{{index+1}}</p>
							</li>
							<li class="col-sm-4" v-for="(kitchen,index) in house_info.kitchen_count">
								<img :src="house_info.follow_imgs.kitchens&&house_info.follow_imgs.kitchens[index]?house_info.follow_imgs.kitchens[index]:'../../../static/img/upload_img.png'" class="follow-up-img" @click="uploadHouseImg('kitchens',index)"/>
				...
				<div class="panel panel-default">
					<div class="panel-heading panel-title">跟进信息</div>
					<div class="panel-body">
						<ul class="col-sm-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading panel-title">角色人信息</div>
					<div class="panel-body">
						<ul class="col-sm-12">
							...
							<li class="character character1" v-if="!upload_agent_cert_employee">
			...
			<!----带看---->
			<div role="tabpanel" class="tab-pane" id="look-with">
				<div class="panel panel-default">
					<div class="panel-heading panel-title">带看信息</div>
					<div class="panel-body">
						<ul class="col-sm-12">
							<see-item v-for="see in house_info.takesees" :employees="employees" :see="see">
							<!--
							<li class="col-sm-12 follow-up-li">
								<div class="look-with-div">
									<i class="fa fa-eye"></i>
									<p class="look-with-s">2017-09-08(周四) 17:00~18:00</p>
									<p class="look-with-x">李翔（星海一组）-18787976581</p>
								</div>
							</li>
							<li class="col-sm-12 follow-up-li">
								<div class="look-with-div">
			...
			<div role="tabpanel" class="tab-pane" id="similar">
				<div class="panel panel-default">
					<div class="panel-heading panel-title">相似房源</div>
					<div class="panel-body">
						<ul class="col-sm-12">
							<li class="col-sm-3">
								<dl>
	...
	<div id="dlg_edit_house_level" :class="{hide:!show_dlg_edit_house_level}" style="display:none">
		...
		<div :class="{'webbox-dlg':true,'animate-show':show_dlg_edit_house_level,'animate-hide':!show_dlg_edit_house_level}" id="webbox-dlg-div">
	...
	<div id="dlg_contract" :class="{hide:!show_dlg_contract}" style="display:none">
		...
		<div :class="{'webbox-dlg':true}" id="webbox-dlg-div" style="border-radius:0px !important;width:30%;left:50%;padding:20px;height:auto;position:fixed;">
			...
			<div class="" style="margin-top:10px;text-align:center;" v-if="house_info.contract">
	...
	<div id="dlg_idpaper" :class="{hide:!show_dlg_idpaper}" style="display:none">
		...
		<div :class="{'webbox-dlg':true}" id="webbox-dlg-div" style="border-radius:0px !important;width:30%;left:50%;padding:20px;height:auto;position:fixed;">
			...
			<div class="" style="margin-top:10px;text-align:center;" v-if="house_info.idpaper">
	...
	<div id="dlg_edit_price" :class="{hide:!show_dlg_edit_price,'is_dlg':true}" style="display:none">
		...
		<div :class="{'webbox-dlg':true}" id="webbox-dlg-div" style="border-radius:0px !important;width:30%;left:50%;padding:20px;height:auto;position:fixed;">
			...
			<div class="" style="margin-top:10px;">
				<label>房源售价：</label>
				<input type="tel" class="form-control" style="display:inline;width:auto"></input>
				<label style="margin-left:5px">万</label>
			</div>
			<div style="margin-top:20px">
				<div style="display:flex">
					<div class="btn btn-info" style="flex:2" @click="applyHouseAgentCert()">确认修改</div>
					<div style="flex:1"></div>
	...
	<div id="dlg_tax_ticket" :class="{hide:!show_dlg_tax_ticket}" style="display:none">
		...
		<div :class="{'webbox-dlg':true}" id="webbox-dlg-div" style="border-radius:0px !important;width:30%;left:50%;padding:20px;height:auto;position:fixed;">
			...
			<div class="" style="margin-top:10px;text-align:center;" v-if="house_info.deed_tax_ticket">
				<img :src="house_info.deed_tax_ticket.id_img" style="width:120px;cursor:pointer;"></img>
			</div>
			<div style="margin-top:20px">
				<div style="display:flex">
	...
	<div id="dlg_veri_report" :class="{hide:!show_dlg_veri_report}" style="display:none">
		...
		<div :class="{'webbox-dlg':true}" id="webbox-dlg-div" style="border-radius:0px !important;width:30%;left:50%;padding:20px;height:auto;position:fixed;">
			...
			<div class="" style="margin-top:10px;text-align:center;" v-if="house_info.veri_report">
	...
	$(function() {
		g_page = new Vue({
			...
			computed:{
				...
				rent_pay_method:function() {
					var s = ['月付','季付','半年付','年付'];
					return s[this.house_info.rent_pay_method];
				},
				...
				rent_house_state:function() {
					var s = ['空房','简配','全齐','豪装'];
					return s[this.house_info.rent_house_state];
				},
				...
				house_address:function() {
					return this.community.name + this.building_block.name+this.building_unit.name+this.house.floor+'楼'+this.house.name;
				}
			},
			created:function() {
