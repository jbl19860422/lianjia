...
<div id="content_warp">
	...
	<div class="submenu">
		<ul class="cityinfo-menus">
			<li  class="active"><a href="houseinfo/house_info_list_page">买卖</a></li>
			<li><a href="houseinfo/house_info_rent_list_page">租赁</a></li>
		</ul>
	</div>
	...
	<div class="mg-c">
		<ul class="sel-menu-ul"role="tablist">
			...
			<li role="presentation" class="sel-menu" @click="if(!school_search.load) school_search.load=true;"><a href="#school-district" role="tab" data-toggle="tab" aria-expanded="false">学区找房</a><div class="wh-line"></div></li>
		...
		<div class="tab-content" id="tab_content_b">
				...
				<div class="list-page-div">
					...
					<div id="all_search_option">
						...
						<div class="form-group form-option">
							...
							<span :class="{active:all_search.min_price==0&&all_search.max_price==100}" @click="all_search.min_price=0;all_search.max_price=100;">100万以下</span>
							<span :class="{active:all_search.min_price==100&&all_search.max_price==150}" @click="all_search.min_price=100;all_search.max_price=150;">100-150万</span>
							<span :class="{active:all_search.min_price==150&&all_search.max_price==200}" @click="all_search.min_price=150;all_search.max_price=200;">150-200万</span>
							<span :class="{active:all_search.min_price==200&&all_search.max_price==250}" @click="all_search.min_price=200;all_search.max_price=250;">200-250万</span>
							<span :class="{active:all_search.min_price==300&&all_search.max_price==500}" @click="all_search.min_price=300;all_search.max_price=500;">300-500万</span>
							<span :class="{active:all_search.min_price==500&&all_search.max_price==1000}" @click="all_search.min_price=500;all_search.max_price=1000;">500-1000万</span>
							<span :class="{active:all_search.min_price==1000}" @click="all_search.min_price=1000;all_search.max_price='';">1000万以上</span>
				...
				<div class="panel panel-default">
					<div class="panel-heading panel-title"  style="border-top:1px solid #ddd">
						<div class="col-sm-12">
							...
							<div class="col-sm-1 all-col all-col-z" @click.stop="setAllSearchOrder('room_count',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click.stop="setAllSearchOrder('area',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click.stop="setAllSearchOrder('price',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click.stop="setAllSearchOrder('floor',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click.stop="setAllSearchOrder('update_time',$event);">
			...
			<div role="tabpanel" class="tab-pane" id="subway">
				<div class="list-page-div" style="padding-top:20px">
					...
					<div class="form-group form-option">
						...
						<span :class="{active:subway_search.min_price==0&&subway_search.max_price==100}" @click="subway_search.min_price=0;subway_search.max_price=100;">100万以下</span>
						<span :class="{active:subway_search.min_price==100&&subway_search.max_price==150}" @click="subway_search.min_price=100;subway_search.max_price=150;">100-150万</span>
						<span :class="{active:subway_search.min_price==150&&subway_search.max_price==200}" @click="subway_search.min_price=150;subway_search.max_price=200;">150-200万</span>
						<span :class="{active:subway_search.min_price==200&&subway_search.max_price==250}" @click="subway_search.min_price=200;subway_search.max_price=250;">200-250万</span>
						<span :class="{active:subway_search.min_price==300&&subway_search.max_price==500}" @click="subway_search.min_price=300;subway_search.max_price=500;">300-500万</span>
						<span :class="{active:subway_search.min_price==500&&subway_search.max_price==1000}" @click="subway_search.min_price=500;subway_search.max_price=1000;">500-1000万</span>
						<span :class="{active:subway_search.min_price==1000}" @click="subway_search.min_price=1000;subway_search.max_price='';">1000万以上</span>
				...
				<div class="panel panel-default">
					<div class="panel-heading panel-title">
						<div class="col-sm-12">
							<div class="col-sm-2 all-col all-col-z">标题图片</div>
							<div class="col-sm-2 all-col all-col-z">楼盘名称</div>
							<div class="col-sm-1 all-col all-col-z" @click="setSubwaySearchOrder('room_count',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click="setSubwaySearchOrder('area',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click="setSubwaySearchOrder('price',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click="setSubwaySearchOrder('floor',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click="setSubwaySearchOrder('update_time',$event);">
			...
			<!--学区找房--->
			<div role="tabpanel" class="tab-pane" id="school-district">
				<div class="list-page-div">
					<div class="form-group list-page-div-group">
						<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="请输入小学名称再进行搜索"  v-model="school_name"></input>
						</div>
						<div class="col-sm-1">
							<span class="btn btn-success list-page-div-btn " @click="school_search.school_name=school_name;school_search.pi=1;">搜索</span>
						</div>
					</div>
					<div class="form-group form-option">
						<span style="padding-left:0px">片区：</span>
						<span :class="{active:school_search.area_id==''}" @click="school_search.area_id=''">不限</span>
						<span v-for="area in areas" v-html="area.name" :class="{active:school_search.area_id==area.area_id}" @click="school_search.area_id=area.area_id"></span>
					</div>
					<div class="form-group form-option">
						<span style="padding-left:0px">筛选：</span>
						<select v-model="school_search.nature">
							<option value="" disabled selected style="display:none">办学性质</option>
							<option value="">不限</option>
							<option value="1">公立学校</option>
							<option value="2">私立学校</option>
							<option value="3">国际学校</option>
						</select>
						<select v-model="school_search.upgrade_method">
							<option value="" disabled selected style="display:none">升学方式</option>
							<option value="">不限</option>
							<option value="1">特等生</option>
						...
						<select v-model="school_search.num_limit">
							<option value="" disabled selected style="display:none">名额性质</option>
							<option value="">不限</option>
				...
				<div style="margin-top:20px;font-weight:bold;font-size:1.8rem;">
					{{show_school_houses?'房源列表':'学区列表'}}
					<span class="pull-right" style="font-size:1.2rem" v-if="!show_school_houses">
						共有<span style="color:#FF6863" v-html="school_total_count"></span>所学校
					</span>
					<a class="pull-right" style="font-size:1.5rem;margin-left:20px;" v-if="show_school_houses&&curr_school.houses" href="javascript:void(0)" @click="show_school_houses=false;">
						返回
					</a>
					<span class="pull-right" style="font-size:1.2rem" v-if="show_school_houses&&curr_school.houses">
						共有<span style="color:#FF6863" v-html="curr_school.houses.length"></span>套房源
					</span>
					
				</div>
				
				<div class="panel panel-default">
					<div class="panel-heading panel-title"  style="border-top:1px solid #ddd" v-show="show_school_houses">
						<div class="col-sm-12">
							<div class="col-sm-2 all-col all-col-z">标题图片</div>
							<div class="col-sm-2 all-col all-col-z">楼盘名称</div>
							<div class="col-sm-1 all-col all-col-z" @click="setSchoolSearchOrder('room_count',$event);">
								户型<i :class="{fa:true,'fa-chevron-down':(school_search.order_name=='room_count'&&school_search.order_type=='desc')||school_search.order_name!='room_count','fa-chevron-up':school_search.order_name=='room_count'&&school_search.order_type=='asc'}"></i>
							</div>
							<div class="col-sm-1 all-col all-col-z" @click="setSchoolSearchOrder('area',$event);">
								面积<i :class="{fa:true,'fa-chevron-down':(school_search.order_name=='area'&&school_search.order_type=='desc')||school_search.order_name!='area','fa-chevron-up':school_search.order_name=='area'&&school_search.order_type=='asc'}"></i>
							</div>
							<div class="col-sm-1 all-col all-col-z" @click="setSchoolSearchOrder('price',$event);">
								总价/单价<i :class="{fa:true,'fa-chevron-down':(school_search.order_name=='price'&&school_search.order_type=='desc')||school_search.order_name!='price','fa-chevron-up':school_search.order_name=='price'&&school_search.order_type=='asc'}"></i>
							</div>
							<div class="col-sm-1 all-col all-col-z" @click="setSchoolSearchOrder('floor',$event);">
								楼层<i :class="{fa:true,'fa-chevron-down':(school_search.order_name=='floor'&&school_search.order_type=='desc')||school_search.order_name!='floor','fa-chevron-up':school_search.order_name=='floor'&&school_search.order_type=='asc'}"></i>
							</div>
							<div class="col-sm-1 all-col all-col-z">朝向</div>
							<div class="col-sm-1 all-col all-col-z" @click.stop="setSchoolSearchOrder('ss_distance',$event);">
								地铁距离<i :class="{fa:true,'fa-chevron-down':(school_search.order_name=='ss_distance'&&school_search.order_type=='desc')||school_search.order_name!='ss_distance','fa-chevron-up':school_search.order_name=='ss_distance'&&school_search.order_type=='asc'}"></i>
							</div>
							<div class="col-sm-1 all-col all-col-z" @click="setSchoolSearchOrder('update_time',$event);">
								挂牌<i :class="{fa:true,'fa-chevron-down':(school_search.order_name=='update_time'&&school_search.order_type=='desc')||school_search.order_name!='update_time','fa-chevron-up':school_search.order_name=='update_time'&&school_search.order_type=='asc'}"></i>
							</div>
							<div class="col-sm-1 all-col all-col-z">维护人</div>
						</div>
					</div>
					<div class="panel-body">
						<school-houses-item v-if="school_page_schools[school_search.pi]&&!show_school_houses" v-for="s in school_page_schools[school_search.pi]" :school="s" @show_school_houses="showSchoolHouses"></school-houses-item>
						<house-item v-if="show_school_houses" v-for="h in curr_school.houses" :house="h" :visited_houses="visited_houses"></house-item>
					</div>
				</div>
			</div>
			<!--聚焦专题--->
				...
				<div class="list-page-div">
					...
					<div id="show_focus_search">
						...
						<div class="form-group form-option">
							...
							<span :class="{active:focus_search.min_price==0&&focus_search.max_price==100}" @click="focus_search.min_price=0;focus_search.max_price=100;">100万以下</span>
							<span :class="{active:focus_search.min_price==100&&focus_search.max_price==150}" @click="focus_search.min_price=100;focus_search.max_price=150;">100-150万</span>
							<span :class="{active:focus_search.min_price==150&&focus_search.max_price==200}" @click="focus_search.min_price=150;focus_search.max_price=200;">150-200万</span>
							<span :class="{active:focus_search.min_price==200&&focus_search.max_price==250}" @click="focus_search.min_price=200;focus_search.max_price=250;">200-250万</span>
							<span :class="{active:focus_search.min_price==300&&focus_search.max_price==500}" @click="focus_search.min_price=300;focus_search.max_price=500;">300-500万</span>
							<span :class="{active:focus_search.min_price==500&&focus_search.max_price==1000}" @click="focus_search.min_price=500;focus_search.max_price=1000;">500-1000万</span>
							<span :class="{active:focus_search.min_price==1000}" @click="focus_search.min_price=1000;focus_search.max_price='';">1000万以上</span>
							<input type="tel" class="form-control form-option-input" v-model="all_price_min" style="width:70px"></input>
							-
							<input type="tel" class="form-control form-option-input" v-model="all_price_max" style="width:70px"></input>
							<span class="form-option-btn" @click="onConfirmAllPrice()">确定</span>
						...
						<div class="form-group form-option">
							...
							-
							<input type="tel" class="form-control form-option-input" v-model="all_room_max"></input>
							<span class="form-option-btn" @click="focus_search.room_count='';focus_search.room_min=all_room_min;focus_search.room_max=all_room_max;">确定</span>
						</div>
						<div class="form-group form-option">
							<span style="padding-left:0px">朝向：</span>
						...
						<div class="form-group form-option">
							...
							-
							<input type="text" class="form-control form-option-input" v-model="all_floor_max"></input>
							<span class="form-option-btn" @click="focus_search.floor_type='';focus_search.floor_min=all_floor_min;focus_search.floor_max=all_floor_max;">确定</span>
						</div>
						<div class="form-group form-option">
							<span style="padding-left:0px">筛选：</span>
							<span style="" class="active">不限</span>
				...
				<div class="panel panel-default">
					<div class="panel-heading panel-title"  style="border-top:1px solid #ddd">
						<div class="col-sm-12">
							<div class="col-sm-2 all-col all-col-z">标题图片</div>
							<div class="col-sm-2 all-col all-col-z">楼盘名称</div>
							<div class="col-sm-1 all-col all-col-z" @click="setFocusSearchOrder('room_count',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click="setFocusSearchOrder('area',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click="setFocusSearchOrder('price',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click="setFocusSearchOrder('floor',$event);">
							...
							<div class="col-sm-1 all-col all-col-z" @click="setFocusSearchOrder('update_time',$event);">
					...
					<div class="panel-body">
						...
						<div class="col-sm-12" style="text-align:center">
							<ul class="pagination">
								<li :class="{disabled:focus_search.pi<focus_page_count}"><a href="javascript:" @click="if(focus_search.pi>=focus_page_count) {focusl_page_changed=true;focus_search.pi--;}">&laquo;</a></li>
								...
								<li :class="{disabled:focus_search.pi>=focus_page_count}"><a href="javascript:" @click="if(focus_search.pi<focus_page_count) {focusl_page_changed=true;focus_search.pi++;}">&raquo;</a></li>								
							</ul>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	var houseItem = Vue.component('house-item', {
		...
		template:	'<div :class="{\'col-sm-12\':true,\'school-district-div\':true,\'active\':visited}">'+
						'<div>'+
							'<div class="col-sm-2 all-col school-district-img" style="position:relative">'+
								'<span class="active" style="position:absolute;left:0px;top:0px;background-color:#FF6D24;color:#fff;border-radius:3px;padding:5px 10px;" v-if="house.info_complete==0">信息不全</span>'+
							...
							'<div class="col-sm-1 all-col all-j">'+
								'<p>{{house.price}}万</p>'+
								'<p>{{parseInt(house.price*10000/house.area)}}元/平</p>'+
							'</div>'+
	...
	$(function() {
		g_page = new Vue({
			...
			created:function() {
				var that = this;
				API.invokeModuleCall(g_host_url, 'houseinfo', 'queryAllHouses', this.all_search, function(json) {
					...
					handler(newval,oldval) {
						...
						if(this.subway_page_changed) {//如果是页面位置变动，则判断是否加载了该页面
							if(typeof(this.subway_page_houses[that.subway_search.pi]) == "undefined") {
								...
								API.invokeModuleCall(g_host_url, 'houseinfo', 'querySubwayHouses', this.subway_search, function(json) {
					...
					handler(newval,oldval) {
						...
						if(this.school_page_changed) {//如果是页面位置变动，则判断是否加载了该页面
							if(typeof(this.school_page_schools[that.school_search.pi]) == "undefined") {
								...
								API.invokeModuleCall(g_host_url, 'houseinfo', 'querySchoolHouses', this.school_search, function(json) {
					...
					handler(newval,oldval) {
						...
						if(this.focus_page_changed) {//如果是页面位置变动，则判断是否加载了该页面
							if(typeof(this.focus_page_houses[that.focus_search.pi]) == "undefined") {
								...
								API.invokeModuleCall(g_host_url, 'houseinfo', 'queryFocusHouses', this.focus_search, function(json) {
			...
			methods:{
				setSubwaySearchOrder:function(v,e) {
				...
				setFocusSearchOrder:function(v,e) {
				...
				setSchoolSearchOrder:function(v,e) {
					if(this.school_search.order_name != v) {
						this.school_search.order_name = v;
						this.school_search.order_type = 'asc';
					} else {
						if(this.school_search.order_type == 'desc') {
							this.school_search.order_type = 'asc';
						} else {
							this.school_search.order_type = 'desc';
						}
					}
					e.stopPropagation();
					e.preventDefault();
				...
				setAllSearchOrder:function(v,e) {
