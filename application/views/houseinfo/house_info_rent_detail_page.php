...
<div id="content_warp">
			...
			<div class="panel-body">
				...
				<div class="col-sm-8">
					<div class="form-group"style="accelerator:60px;">
						<div class="col-sm-6">
							<div class="price"><P style="width:165px">{{house_info.price}}</p><div><i class="fa fa-arrow-circle-down"></i><p>元/月</p></div></div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7 availability-c">
							<div class="fl-l availability-c-div" style="position:relative">
								<span><a style="color:inherit" href="javascript:" @click="show_add_follow_panel=true;location.hash='add_follow_panel'">录入跟进</a></span>
								<span>|</span>
		...
		<div class="tab-content" id="tab_content_b">
			...
			<div role="tabpanel" class="tab-pane active" id="description">
				...
				<div class="panel panel-default" id="ID_maintain_info">
					<div class="panel-heading panel-title">
						<p class="panel-p">维护信息</p><i :class="{fa:true,'fa-angle-double-down':!show_maintain_info,'fa-angle-double-up':show_maintain_info}" @click="show_maintain_info=!show_maintain_info" style="font-size:2.5rem;font-weight:bolder;margin-left:10px;cursor:pointer;"></i>
				...
				<div class="panel panel-default">
					<div class="panel-heading panel-title"><p class="panel-p">证件信息</p><i :class="{fa:true,'fa-angle-double-down':!show_cert_info,'fa-angle-double-up':show_cert_info}" @click="show_cert_info=!show_cert_info" style="font-size:2.5rem;font-weight:bolder;margin-left:10px;cursor:pointer;"></i></div>
			...
			<div role="tabpanel" class="tab-pane active" id="follow-up">
				...
				<div class="panel panel-default">
					<div class="panel-heading panel-title">
					<p class="panel-p">房屋照片信息</p>
					<i :class="{fa:true,'fa-angle-double-down':!show_house_img,'fa-angle-double-up':show_house_img}" @click="show_house_img=!show_house_img" style="font-size:2.5rem;font-weight:bolder;margin-left:10px;cursor:pointer;"></i></div>
					<div class="panel-body" v-show="show_house_img">
						<ul class="col-sm-12">
							<li class="col-sm-4" v-for="(room,index) in house_info.room_count">
				...
				<div class="panel panel-default"  id="add_follow_panel">
					...
					<div class="panel-body" v-show="show_add_follow_panel">
						<div class="form-group">
							<form class="form-horizontal">
								<div class="form-group">
			...
			<div role="tabpanel" class="tab-pane active" id="look-with">
				<div class="panel panel-default">
					<div class="panel-heading panel-title"><p class="panel-p">带看信息</p><i :class="{fa:true,'fa-angle-double-down':!show_takesee_info,'fa-angle-double-up':show_takesee_info}" @click="show_takesee_info=!show_takesee_info" style="font-size:2.5rem;font-weight:bolder;margin-left:10px;cursor:pointer;"></i></div>
		...
		<div :class="{'webbox-dlg':true}" id="webbox-dlg-div" style="border-radius:0px !important;width:30%;left:50%;padding:20px;height:auto;position:fixed;">
			...
			<div class="form-inline" style="margin-top:10px;">
				...
				<select class="form-control" v-model="recommend_em_id">
					<option v-for="e in com_maintainers" :value="e.employee_id" v-html="e.name"></option>
				</select>
			</div>
			<div style="margin-top:20px">
				<div style="display:flex">
	...
	<div id="dlg_apply_maintainer" :class="{hide:!show_dlg_apply_maintainer,is_dlg:true}" style="display:none">
		...
		<div :class="{'webbox-dlg':true}" id="webbox-dlg-div" style="border-radius:0px !important;width:20%;left:50%;padding:20px;height:auto;position:fixed;">
			<div class="" style="height:auto;text-align:center;">
				<label style="font-size:2rem">是否确实房源在租？</label>
			</div>
			<div style="margin-top:20px">
				<div style="display:flex">
