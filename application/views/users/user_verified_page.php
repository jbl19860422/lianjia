						...
						<div class="form-v">
                            ...
                            <form class="form-horizontal" v-show="curr_step==3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                    	<input type="text" name="name" class="form-control time-end" placeholder="身份证到期时间">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                	<div class="col-sm-3 col-sm-offset-4">
                                		<a type="submit" class="btn btn-primary" @click="commit()">提交审核</a>
                                	</div>
                                </div>
                            </form>
						</div>
		...
		g_page = new Vue({
			...
			methods:{
				commit:function() {
					...
					API.invokeModuleCall(g_host_url, 'user','verifyUser', this.vinfo, function(json) {
						if(json.code == 0) {
							showMsg('提交成功');
							history.back();
						}
