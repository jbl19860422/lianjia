$(function() {
/**************按钮组件--编辑***************/
	 var btnComPanel = Vue.component('btn-com-panel', {
		props:['prop','pages','page_groups','acts'],
		template:
		'<div class="col-md-12 col-lg-12 col-sm-12">'+
			'<ul class="nav nav-tabs">'+
				'<li class="active" style="width:50%;">'+
					'<a data-tab :href="\'#ID_editPanel1_\'+prop.id" ><i class="icon  icon-book"></i>按钮组件</a>'+
				'</li>'+
				'<li style="width:50%">'+
			...
			'<div class="tab-content" style="background-color:#f6f6f6;border-bottom-left-radius:10px;border-bottom-right-radius:10px;">'+
				'<btn-com-panel1 :prop="prop" :pages="pages" :page_groups="page_groups" :acts="acts"></btn-com-panel1>'+
				'<btn-com-panel2 :prop="prop"></btn-com-panel2>'+
			'</div>'+
			'<div style="clear:both;"></div>'+
		'</div>'
	 });
	/**************按钮组件--编辑1*****************/
	 var btnComPanel1 = Vue.component('btn-com-panel1',{
		props:['prop', 'pages', 'page_groups','acts'],
		template:
	...
	/**************按钮组件--编辑2*****************/
	var btnComPanel2 = Vue.component('btn-com-panel2',{
		props:['prop'],
		template:
			...
			'<div>'+
			  ...
			  '<div id="ID_com_setting" style="font-size:20px;color:#666;padding-top:20px;padding-left:10px;border-bottom-left-radius:8px;border-bottom-right-radius:8px;border:1px solid #aaaaaa">'+
			    '<div>'+
		    		...
		    		'<div style="float:left;margin-left:30px;margin-right:10px;">宽</div>'+
		    		'<div class="my-spinner input-btn-width" style="float:left">'+
							'<div class="input-area">'+
								'<input style="font-size:20px" :value="prop.styles.sizeStyle[\'width\'].substr(0,prop.styles.sizeStyle[\'width\'].length-2)"></input>'+
					...
					'<div style="margin-top:10px">'+
						...
						'<div style="float:left;margin-left:30px" class="position-btns">'+
					...
					'<div style="clear:both;margin-top:30px;margin-bottom:20px;height:40px;">'+
						...
						'</div>'+
					'</div>'+
					'<div style="font-size:20px;clear:both;margin-top:30px;" class="border-radius-setting">'+
						'<div style="margin-right:10px;float:left;">圆角</div>'+
						'<div class="my-spinner input-border-radius" style="float:left;margin-left:20px;">'+
							'<div class="input-area">'+
		...
		mounted:function() {
			...
			$(this.$el).find(".position-btns").children("span").click(function() {
				...
				//that.prop.styles.alignStyle['text-align'] = $(this).attr("align");
			});
